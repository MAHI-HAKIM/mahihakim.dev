...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="min-h-screen flex items-center py-12 sm:py-16 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        >
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gradient mb-3 sm:mb-4">About Me</h2>
              ...
              <div className="grid gap-2 sm:gap-3">
                {highlights.map((highlight, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="flex items-center space-x-2 sm:space-x-3 group hover:bg-gray-800/20 rounded-lg p-1.5 sm:p-2 transition-all duration-300"
                  >
                    {/* Enhanced shiny bullet point */}
                    <div className="relative flex-shrink-0">
                      {/* Outer animated glow ring */}
                      <div className="absolute inset-0 w-4 h-4 sm:w-5 sm:h-5 bg-gradient-to-r from-blue-400/20 to-purple-400/20 rounded-full blur-md opacity-0 group-hover:opacity-100 group-hover:scale-150 transition-all duration-500 animate-pulse" />

                      {/* Secondary glow ring */}
                      <div className="absolute inset-0 w-4 h-4 sm:w-5 sm:h-5 bg-gradient-to-r from-cyan-400/30 to-blue-400/30 rounded-full blur-sm opacity-60 group-hover:opacity-80 group-hover:scale-125 transition-all duration-300" />

                      {/* Main chrome bullet with gradient */}
                      <div className="relative w-4 h-4 sm:w-5 sm:h-5 bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 rounded-full group-hover:scale-110 transition-all duration-300 shadow-lg">
                        {/* Top shine highlight */}
                        ...
                        <div className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          <div className="absolute top-1 left-1 w-0.5 h-0.5 sm:w-1 sm:h-1 bg-white rounded-full animate-ping" />
                          <div className="absolute bottom-1 right-1 w-0.5 h-0.5 bg-blue-200 rounded-full animate-pulse" />
                        </div>
                      </div>

                      {/* Reflection effect */}
                      <div className="absolute inset-0 w-4 h-4 sm:w-5 sm:h-5 bg-gradient-to-br from-white/10 via-transparent to-transparent rounded-full group-hover:from-white/20 transition-all duration-300" />
                    </div>

                    <highlight.icon className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 group-hover:text-white transition-colors flex-shrink-0" />
              ...
              <div className="grid gap-3 sm:gap-4">
                {skills.map((skillGroup, index) => (
                  <motion.div
                    ...
                    className="group"
                  >
                    <h4 className="text-xs sm:text-sm font-medium text-gray-400 mb-1.5 sm:mb-2 group-hover:text-white transition-colors">
                      {skillGroup.category}
                    </h4>
                    <div className="flex flex-wrap gap-1 sm:gap-1.5">
                      {skillGroup.items.map((skill) => (
                        <span
                          key={skill}
                          className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-gray-800/50 border border-gray-600/30 rounded text-xs text-gray-300 hover:border-gray-400/50 hover:bg-gray-700/50 hover:scale-105 transition-all duration-200"
                        >
                          {skill}
                        </span>
                      ))}
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-start space-x-2 sm:space-x-3">
                  <div className="relative flex-shrink-0 mt-1.5 sm:mt-2">
                    {/* Mini shiny bullet */}
                    <div className="absolute inset-0 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-gradient-to-r from-blue-400/20 to-purple-400/20 rounded-full blur-sm" />
                    <div className="relative w-2.5 h-2.5 sm:w-3 sm:h-3 bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 rounded-full shadow-sm">
                  ...
                  <div>
                    <h4 className="text-xs sm:text-sm font-medium text-white mb-0.5 sm:mb-1">Full-Stack Development</h4>
                ...
                <div className="flex items-start space-x-2 sm:space-x-3">
                  <div className="relative flex-shrink-0 mt-1.5 sm:mt-2">
                    {/* Mini shiny bullet */}
                    <div className="absolute inset-0 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-gradient-to-r from-emerald-400/20 to-cyan-400/20 rounded-full blur-sm" />
                    <div className="relative w-2.5 h-2.5 sm:w-3 sm:h-3 bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 rounded-full shadow-sm">
                      <div className="absolute inset-0.5 bg-gradient-to-br from-white/50 to-transparent rounded-full" />
                      <div className="absolute inset-1 bg-white/30 rounded-full" />
                    </div>
                  ...
                  <div>
                    <h4 className="text-xs sm:text-sm font-medium text-white mb-0.5 sm:mb-1">AI Automation</h4>
                ...
                <div className="flex items-start space-x-2 sm:space-x-3">
                  <div className="relative flex-shrink-0 mt-1.5 sm:mt-2">
                    {/* Mini shiny bullet */}
                    <div className="absolute inset-0 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-gradient-to-r from-orange-400/20 to-red-400/20 rounded-full blur-sm" />
                    <div className="relative w-2.5 h-2.5 sm:w-3 sm:h-3 bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 rounded-full shadow-sm">
                      <div className="absolute inset-0.5 bg-gradient-to-br from-white/50 to-transparent rounded-full" />
                      <div className="absolute inset-1 bg-white/30 rounded-full" />
                    </div>
                  ...
                  <div>
                    <h4 className="text-xs sm:text-sm font-medium text-white mb-0.5 sm:mb-1">Content Creation</h4>
